...
const CardAbout = ({id, title, subtitle, icons}) => {
    return (
        <div
            className={"mx-5 my-5 md:w-1/5 w-[70vw] md:h-[250px] relative bg-[#01859A] rounded-3xl py-9 px-5  flex flex-col justify-center items-center hover:bg-[#00A7C1] duration-300 ease"}>
